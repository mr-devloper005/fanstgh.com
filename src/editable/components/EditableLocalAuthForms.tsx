...
const inputClass = 'h-12 rounded-2xl border border-black/10 bg-white px-4 text-base font-bold text-[#1b1530] outline-none transition placeholder:font-semibold placeholder:text-[#1b1530]/40 focus:border-[#6d28d9] focus:ring-2 focus:ring-[#6d28d9]/20'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-2xl bg-[#6d28d9] px-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#5b21b6] disabled:opacity-60'
